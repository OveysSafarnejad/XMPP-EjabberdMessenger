...
@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate, OneRosterDelegate , XMPPStreamDelegate  {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "MessengerUIKitGeneral")
